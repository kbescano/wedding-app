...
import { FAKE_TABLES } from '../fixtures.js';
...
export default function Seating() {
  ...
  useEffect(() => {
    if (locked) return;
    api.get('/api/seating').then(setData).catch(() => setData({ published: false, tables: [], mine: null }));
  }, [locked, role]);
  ...
  const unpublished = !locked && data && !data.published;
