...
import { Countdown, Petals, Reveal, Words } from '../components/Motion.jsx';
import { useAuth } from '../context.jsx';
import { useToast } from '../toast.jsx';
import { api } from '../api.js';
import { clock, downloadCalendar, longDate, parseDate, shortDate, weekday } from '../format.js';
...
function Rsvp({ event }) {
  ...
  const submit = async (e) => {
    ...
    setSaving(true);
    try {
      const res = await api.post('/api/rsvp', { status, count, meal, note });
      setGuest(res.guest);
      setEditing(false);
