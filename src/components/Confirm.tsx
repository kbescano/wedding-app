...
type Props = { onConfirm: () => void; label?: string; className?: string }

/** A trash button that asks "sure?" inline before firing. */
export default function ConfirmDelete({ onConfirm, label = 'Delete', className = '' }: Props) {
